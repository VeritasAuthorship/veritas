import pandas as pd
from utils import Example, Indexer
import random


def spooky_authorship_data(test_split=0.7, max_char_length=500):
    ...
    examples = [Example(passage, author) for passage, author in zip(train_df["text"], train_df["author"]) if len(passage) <= max_char_length]
